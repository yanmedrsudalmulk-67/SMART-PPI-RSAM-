  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const sessionPayload = {
        indikator_id: 'audit_ruang_tunggu', // Menggunakan nama tabel sebagai indikator ID
        nama_indikator: 'AUDIT RUANG TUNGGU',
      ...
      const { error } = await supabase.from('audit_ruang_tunggu').insert([insertData]);
