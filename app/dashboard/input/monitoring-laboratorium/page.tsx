  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const sessionPayload = {
        indikator_id: 'audit_laboratorium_monitoring', // Menggunakan nama tabel sebagai indikator ID
        nama_indikator: 'AUDIT LABORATORIUM MONITORING',
      ...
      const { error } = await supabase.from('audit_laboratorium_monitoring').insert([insertData]);
