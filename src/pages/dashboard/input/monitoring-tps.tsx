...
const checklistGroups = [
  {
    ...
    items: [
      ...
      {
        id: "tb_4",
        label: "Lantai kuat, rata, kedap air, dan mudah dibersihkan",
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "ps_4",
        label: "Limbah tajam menggunakan safety box/container khusus",
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "psd_5",
        label: "Jalur pengangkutan aman dan tidak melewati area bersih",
      },
      ...
      if (id && mode === "edit") {
        ...
        const loadEditData = async () => {
          ...
          if (ed && !error) {
            ...
            const waktu = indicatorsData.waktu_perbaikan || indicatorsData.tanggal_perbaikan || ed.waktu_perbaikan || ed.tanggal_perbaikan || "";
            if (waktu) setWaktuPerbaikan(waktu);
      ...
      <div className="flex items-center gap-6 mb-8 py-6 border-b border-white/5">
        ...
        <div>
          ...
          <p className="text-[10px] sm:text-xs font-bold uppercase tracking-[0.3em] text-blue-500/80 mt-2 flex items-center gap-2">
            ...
            Audit kepatuhan Pencegahan dan Pengendalian Infeksi area TPS Rumah
            Sakit
          </p>
        </div>
      </div>
