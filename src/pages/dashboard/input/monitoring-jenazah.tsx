...
const checklistItems = [
  {
    ...
    items: [
      ...
      {
        id: "a5",
        label: "Wastafel cuci tangan selalu bersih dan bebas dari peralatan",
      },
    ...
    items: [
      {
        id: "b1",
        label:
          "Tersedia APD lengkap (sarung tangan, masker, tutup kepala, goggles, apron, sepatu boot)",
      },
      {
        id: "b2",
        label:
          "Alat cuci tangan lengkap (wastafel, sabun antiseptik, tissue, handrub)",
      },
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-32">
      ...
      <div className="flex items-center gap-6 py-6 border-b border-slate-200 dark:border-white/5">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-slate-600 via-slate-500 to-gray-600 dark:from-slate-400 dark:via-gray-300 dark:to-slate-400 uppercase">
            Input Audit Kamar Jenazah
          </h1>
          <p className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400 mt-1">
            Audit kepatuhan Pencegahan dan Pengendalian Infeksi area Kamar
            Jenazah
          </p>
        </div>
      </div>
