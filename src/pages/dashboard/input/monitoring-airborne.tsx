...
export default function MonitoringAirbornePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await supabase.from(tableName || 'audit_airborne').insert([{ ...sessionPayload, created_at: new Date().toISOString() }]);
    ...
    <div className="max-w-3xl mx-auto pb-32">
      ...
      <div className="flex items-center gap-6 py-6 border-b border-white/5">
        ...
        <div>
          ...
          <p className="text-[10px] font-bold uppercase tracking-widest text-blue-400 mt-1">Ruang tekanan negatif, exhaust fan, pintu tertutup</p>
        </div>
      </div>
