...
const auditItems = [
  ...
  {
    id: "disposable",
    label: "Spuit sekali pakai (disposable) dan steril",
    key: "disposable",
  },
  { id: "no_reuse", label: "Spuit tidak digunakan berulang", key: "no_reuse" },
  {
    id: "no_touch_sterile",
    label: "Tidak menyentuh bagian steril jarum",
    key: "no_touch_sterile",
  },
  {
    id: "area_disinfection",
    label: "Desinfeksi area penyuntikan",
    key: "area_disinfection",
  },
  {
    id: "antiseptic_standard",
    label: "Menggunakan antiseptik sesuai standar",
    key: "antiseptic_standard",
  },
  {
    id: "no_recapping",
    label: "Tidak menutup kembali jarum (no recapping)",
    key: "no_recapping",
  },
  {
    id: "safety_box",
    label: "Jarum langsung dibuang ke safety box",
    key: "safety_box",
  },
  {
    id: "no_bending",
    label: "Tidak membengkokkan atau mematahkan jarum",
    key: "no_bending",
  },
] as const;
...
export default function InputPenyuntikanAmanPage() {
  ...
  const [auditData, setAuditData] = useState<Record<string, AuditStatus>>({
    ...
    disposable: null,
    no_reuse: null,
    no_touch_sterile: null,
    area_disinfection: null,
    antiseptic_standard: null,
    no_recapping: null,
    safety_box: null,
    no_bending: null,
  });
  ...
  return (
    <div className="max-w-4xl mx-auto pb-32">
      ...
      <div className="flex items-center gap-4 mb-8 py-6 border-b border-white/5">
        ...
        <div>
          ...
          <p className="text-[10px] sm:text-xs font-bold uppercase tracking-[0.1em] text-blue-400 mt-1">
            Dokumentasi kepatuhan prosedur penyuntikan yang aman
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="sm:col-span-2">
              ...
              >
                ...
                {actionTypes.map((at) => (
                  <option key={at} value={at} className="bg-slate-900">
                    {at}
                  </option>
                ))}{" "}
              </select>
        ...
        <div className="bg-white/5 p-6 rounded-[24px] border border-white/5 shadow-sm">
          <h2 className="flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-slate-400 mb-6">
            <FileText className="w-4 h-4 text-amber-400" /> CEKLIST PENYUNTIKAN
            YANG AMAN
          </h2>
...
InputPenyuntikanAmanPage.getLayout = function getLayout(
