...
const auditItems = [
  { id: 'hh', label: '1. Kebersihan tangan', key: 'hh' },
  { id: 'apd', label: '2. APD indikasi', key: 'apd' },
  { id: 'disposable', label: '3. Spuit sekali pakai', key: 'disposable' },
  { id: 'no_reuse', label: '4. Spuit no reuse', key: 'no_reuse' },
  { id: 'no_touch_sterile', label: '5. No touch steril', key: 'no_touch_sterile' },
  { id: 'area_disinfection', label: '6. Desinfeksi area', key: 'area_disinfection' },
  { id: 'antiseptic_standard', label: '7. Antiseptik standar', key: 'antiseptic_standard' },
  { id: 'no_recapping', label: '8. No recapping', key: 'no_recapping' },
  { id: 'safety_box', label: '9. Safety box langsung', key: 'safety_box' },
  { id: 'no_bending', label: '10. No bending jarum', key: 'no_bending' }
] as const;
  ...
  return (
    <div className="max-w-7xl mx-auto pb-32">
      <AnimatePresence>
        {showToast && (
          ...
          >
            ...
            Data Audit Penyuntikan Aman Tersimpan!
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <div className="flex items-center gap-6 mb-8 py-6 border-b border-white/5">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r bg-[length:200%_auto] animate-gradient drop-shadow-[0_0_10px_rgba(59,130,246,0.4)] from-blue-400 via-purple-500 to-blue-400">Audit Penyuntikan Aman</h1>
          <p className="text-[10px] sm:text-xs font-bold uppercase tracking-[0.1em] text-blue-400 mt-1">Observasi kepatuhan prosedur penyuntikan yang aman</p>
        </div>
      </div>
