...
import { 
  ShieldAlert, Activity, ClipboardCheck, GraduationCap, ArrowRight 
} from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {inputModules.map((mod, i) => (
          ...
          >
            <Link 
              href={mod.href}
              className="block h-full bg-white/5 backdrop-blur-xl rounded-[32px] p-8 border border-white/5 hover:border-white/20 hover:-translate-y-2 transition-all duration-500 group relative overflow-hidden"
            >
              ...
              <div className="flex items-start justify-between mb-10">
                ...
                <div className="text-right">
                  <p className="text-3xl font-bold text-white">{mod.dataCount}</p>
