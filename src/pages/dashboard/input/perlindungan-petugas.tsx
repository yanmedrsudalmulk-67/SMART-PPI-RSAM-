...
const units = [
  'IGD', 'ICU', 'IBS', 'Ranap Aisyah', 
  'Ranap Fatimah', 'Ranap Khadijah', 'Ranap Usman', 
  'Laboratorium', 'Radiologi', 'Farmasi', 'Rawat Jalan'
];
  ...
  return (
    <div className="max-w-4xl mx-auto pb-16">
      ...
      <div className="flex items-center gap-4 mb-8 py-6 border-b border-white/5">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r bg-[length:200%_auto] animate-gradient drop-shadow-[0_0_10px_rgba(59,130,246,0.4)] from-blue-400 via-purple-500 to-blue-400">Audit Perlindungan Petugas</h1>
          <p className="text-[10px] sm:text-xs font-bold uppercase tracking-[0.1em] text-blue-400 mt-1">Observasi kesehatan dan perlindungan staf</p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white/5 p-6 rounded-[24px] border border-white/5 shadow-sm">
          <h2 className="flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-slate-400 mb-6">
            <FileText className="w-4 h-4 text-amber-400" /> CEKLIST PERLINDUNGAN KESEHATAN PETUGAS
          </h2>
