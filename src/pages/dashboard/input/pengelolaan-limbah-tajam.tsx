...
const auditItems = [
  { id: 'item_1', label: '1. Safety box sesuai WHO', key: 'item_1' },
  { id: 'item_2', label: '2. Wadah aman', key: 'item_2' },
  { id: 'item_3', label: '3. Wadah < 3/4 penuh', key: 'item_3' },
  { id: 'item_4', label: '4. Tidak ada tajam keluar', key: 'item_4' },
  { id: 'item_5', label: '5. Tajam masuk wadah tajam', key: 'item_5' },
  { id: 'item_6', label: '6. Tong tajam di troli', key: 'item_6' },
  { id: 'item_7', label: '7. 1 tangan / no recapping', key: 'item_7' },
  { id: 'item_8', label: '8. Jalur paska pajanan', key: 'item_8' }
] as const;
  ...
  return (
    <div className="max-w-7xl mx-auto pb-32">
      <AnimatePresence>
        {showToast && (
          ...
          >
            ...
            Data Audit Pengelolaan Limbah Tajam Tersimpan!
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <div className="flex items-center gap-6 mb-8 py-6 border-b border-white/5">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r bg-[length:200%_auto] animate-gradient drop-shadow-[0_0_10px_rgba(59,130,246,0.4)] from-blue-400 via-purple-500 to-blue-400">Audit Pengelolaan Limbah Tajam</h1>
          <p className="text-[10px] sm:text-xs font-bold uppercase tracking-[0.1em] text-blue-400 mt-1">Observasi pembuangan benda tajam dan jarum</p>
        </div>
      </div>
