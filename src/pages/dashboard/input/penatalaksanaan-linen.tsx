...
const auditItems = [
  { id: 'item_1', label: '1. Linen bersih disimpan lemari tertutup', key: 'item_1' },
  { id: 'item_2', label: '2. Troli tertutup kotor', key: 'item_2' },
  { id: 'item_3', label: '3. Kantung kuning infeksius', key: 'item_3' },
  { id: 'item_4', label: '4. Linen kotor dipisah', key: 'item_4' },
  { id: 'item_5', label: '5. Petugas APD infeksius', key: 'item_5' }
] as const;

type AuditStatus = 'ya' | 'tidak' | 'na' | null;

export default function InputPenatalaksanaanLinenPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto pb-32">
      <AnimatePresence>
        {showToast && (
          ...
          >
            ...
            Data Audit Penatalaksanaan Linen Tersimpan!
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <div className="flex items-center gap-6 mb-8 py-6 border-b border-white/5">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r bg-[length:200%_auto] animate-gradient drop-shadow-[0_0_10px_rgba(59,130,246,0.4)] from-blue-400 via-purple-500 to-blue-400">Audit Penatalaksanaan Linen</h1>
          <p className="text-[10px] sm:text-xs font-bold uppercase tracking-[0.1em] text-blue-400 mt-1">Observasi pengelolaan linen dan laundry</p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <LiveStatisticsCard 
          ...
          persentase={stats.persentase} statusText={stats.statusText} title="KEPATUHAN PENATALAKSANAAN LINEN"
        />
...
InputPenatalaksanaanLinenPage.getLayout = function getLayout(page: ReactElement) {
