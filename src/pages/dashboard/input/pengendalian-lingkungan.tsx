...
const auditItems = [
  { id: 'item_1', label: '1. Kursi/meja/dan loker tampak bersih', key: 'item_1' },
  { id: 'item_2', label: '2. Troli tindakan tampak bersih', key: 'item_2' },
  { id: 'item_3', label: '3. Troli tindakan dibersihkan dan didesinfeksi', key: 'item_3' },
  { id: 'item_4', label: '4. Lantai bersih dan dalam kondisi baik', key: 'item_4' },
  { id: 'item_5', label: '5. Ditemukan debu di permukaan kerja', key: 'item_5' },
  { id: 'item_6', label: '6. Tirai pemisah bersih', key: 'item_6' },
  { id: 'item_7', label: '7. Kipas angin dan AC bersih', key: 'item_7' },
  { id: 'item_8', label: '8. Dinding bebas jamur', key: 'item_8' },
  { id: 'item_9', label: '9. Ventilasi/jendela bersih', key: 'item_9' },
  { id: 'item_10', label: '10. Area tunggu bersih', key: 'item_10' }
] as const;
    ...
    <div className="max-w-7xl mx-auto pb-32">
      ...
      <div className="space-y-6">
        ...
        <LiveStatisticsCard 
          ...
          persentase={stats.persentase} statusText={stats.statusText} title="KEPATUHAN PENGENDALIAN LINGKUNGAN"
        />
...
InputPengendalianLingkunganPage.getLayout = function getLayout(page: ReactElement) {
