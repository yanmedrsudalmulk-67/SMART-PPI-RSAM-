...
export function LiveStatisticsCard({
  ...
  return (
    <div className="bg-white/5 backdrop-blur-xl p-6 sm:p-8 rounded-[32px] border border-white/5 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 relative overflow-hidden mt-6 mb-6 shadow-2xl">
      ...
      <div className="flex flex-col items-center mt-12 md:mt-4">
        <div className="relative w-40 h-40 flex items-center justify-center shrink-0 mb-4">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <span className="text-4xl font-bold text-white">{displayPersen}</span>
          </div>
        </div>
